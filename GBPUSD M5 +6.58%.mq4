...
//
// Copyright 2022, Joao Marcilio.
//
// 

#property copyright "Joao Marcilio"
...
static input string ___0______   = "------"; // --- Average True Range ---
       input int    Ind0Param0   =       16; // Period
       input double Ind0Param1   =   0.0011; // Level

static input string ___1______   = "------"; // --- Stochastic Signal ---
       input int    Ind1Param0   =        8; // %K Period
       input int    Ind1Param1   =        8; // %D Period
       input int    Ind1Param2   =        8; // Slowing

static input string ___2______   = "------"; // --- Average True Range ---
       input int    Ind2Param0   =       55; // Period
       input double Ind2Param1   =   0.0019; // Level

static input string ___3______   = "------"; // --- Moving Averages Crossover ---
       input int    Ind3Param0   =        7; // Fast MA period
       input int    Ind3Param1   =       54; // Slow MA period

static input string _Settings___ = "------"; // --- Expert Settings ---
static input int    Magic_Number = 13839257; // Magic Number
...
int GetEntrySignal()
  {
   // Average True Range (16), Level: 0.0011
   double ind0val1  = iATR(NULL, 0, Ind0Param0, 1);
   bool   ind0long  = ind0val1 < Ind0Param1 - sigma;
   bool   ind0short = ind0long;

   // Stochastic Signal (8, 8, 8)
   double ind1val1  = iStochastic(NULL, 0, Ind1Param0, Ind1Param1, Ind1Param2, MODE_SMA, 0, MODE_MAIN,   1);
   double ind1val2  = iStochastic(NULL, 0, Ind1Param0, Ind1Param1, Ind1Param2, MODE_SMA, 0, MODE_SIGNAL, 1);
   double ind1val3  = iStochastic(NULL, 0, Ind1Param0, Ind1Param1, Ind1Param2, MODE_SMA, 0, MODE_MAIN,   2);
   double ind1val4  = iStochastic(NULL, 0, Ind1Param0, Ind1Param1, Ind1Param2, MODE_SMA, 0, MODE_SIGNAL, 2);
...
void ManageClose()
  {
   // Average True Range (55), Level: 0.0019
   ...
   // Moving Averages Crossover (Simple, Simple, 7, 54)
   double ind3val1  = iMA(NULL, 0, Ind3Param0, 0, MODE_SMA, PRICE_CLOSE, 1);
   double ind3val2  = iMA(NULL, 0, Ind3Param1, 0, MODE_SMA, PRICE_CLOSE, 1);
   double ind3val3  = iMA(NULL, 0, Ind3Param0, 0, MODE_SMA, PRICE_CLOSE, 2);
   double ind3val4  = iMA(NULL, 0, Ind3Param1, 0, MODE_SMA, PRICE_CLOSE, 2);
   ...
   if ( (posType == OP_BUY  && (ind2long || ind3long)) ||
        (posType == OP_SELL && (ind2short || ind3short)) )
      ClosePosition();
  }
//+------------------------------------------------------------------+
//|                                                                  |
