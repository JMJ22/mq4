...
static input string ___0______   = "------"; // --- Commodity Channel Index ---
       input int    Ind0Param0   =       13; // Period
       input int    Ind0Param1   =        8; // Level

static input string ___1______   = "------"; // --- Directional Indicators ---
       input int    Ind1Param0   =        5; // Period

static input string ___2______   = "------"; // --- Bollinger Bands ---
       input int    Ind2Param0   =        8; // Period
       input double Ind2Param1   =     1.73; // Deviation

static input string ___3______   = "------"; // --- RSI ---
       input int    Ind3Param0   =       30; // Period
       input int    Ind3Param1   =       30; // Level

static input string _Settings___ = "------"; // --- Expert Settings ---
static input int    Magic_Number = 6462030; // Magic Number
...
int GetEntrySignal()
  {
   // Commodity Channel Index (Typical, 13), Level: 8
...
void ManageClose()
  {
   // Bollinger Bands (Close, 8, 1.73)
   double ind2upBand1 = iBands(NULL, 0, Ind2Param0, Ind2Param1, 0, PRICE_CLOSE, MODE_UPPER, 1);
   double ind2dnBand1 = iBands(NULL, 0, Ind2Param0, Ind2Param1, 0, PRICE_CLOSE, MODE_LOWER, 1);
   double ind2upBand2 = iBands(NULL, 0, Ind2Param0, Ind2Param1, 0, PRICE_CLOSE, MODE_UPPER, 2);
   double ind2dnBand2 = iBands(NULL, 0, Ind2Param0, Ind2Param1, 0, PRICE_CLOSE, MODE_LOWER, 2);
   ...
   // RSI (Close, 30)
   double ind3val1  = iRSI(NULL, 0, Ind3Param0, PRICE_CLOSE, 1);
   double ind3val2  = iRSI(NULL, 0, Ind3Param0, PRICE_CLOSE, 2);
   double ind3val3  = iRSI(NULL, 0, Ind3Param0, PRICE_CLOSE, 3);
