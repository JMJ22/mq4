...
static input string ___0______   = "------"; // --- MACD ---
       input int    Ind0Param0   =        3; // Fast EMA
       input int    Ind0Param1   =       31; // Slow EMA
       input int    Ind0Param2   =        9; // MACD SMA

static input string ___1______   = "------"; // --- MACD ---
       input int    Ind1Param0   =       12; // Fast EMA
       input int    Ind1Param1   =        5; // Slow EMA
       input int    Ind1Param2   =        9; // MACD SMA

static input string ___2______   = "------"; // --- Exit Time ---
       input int    Ind2Param0   =        2; // From hour
       input int    Ind2Param1   =        0; // From minute
       input int    Ind2Param2   =       18; // Until hour
       input int    Ind2Param3   =       59; // Until minute

static input string _Settings___ = "------"; // --- Expert Settings ---
static input int    Magic_Number = 99508183; // Magic Number
...
int GetEntrySignal()
  {
   // MACD (Close, 3, 31, 9)
   double ind0val1  = iMACD(NULL, 0, Ind0Param0, Ind0Param1, Ind0Param2, PRICE_CLOSE, MODE_MAIN, 1);
   bool   ind0long  = ind0val1 > 0 + sigma;
   bool   ind0short = ind0val1 < 0 - sigma;

   // MACD (Close, 12, 5, 9)
   double ind1val1  = iMACD(NULL, 0, Ind1Param0, Ind1Param1, Ind1Param2, PRICE_CLOSE, MODE_MAIN, 1);
   double ind1val2  = iMACD(NULL, 0, Ind1Param0, Ind1Param1, Ind1Param2, PRICE_CLOSE, MODE_MAIN, 2);
...
void ManageClose()
  {
   ...
   int fromTime2  = Ind2Param0 * 3600 + Ind2Param1 * 60;
   int untilTime2 = Ind2Param2 * 3600 + Ind2Param3 * 60;

   MqlDateTime mqlTime2; TimeToStruct(Time(0), mqlTime2);
   int barMinutes2 = mqlTime2.hour*3600 + mqlTime2.min*60;

   bool isOnTime2 = fromTime2 < untilTime2
      ? barMinutes2 >= fromTime2 && barMinutes2 <= untilTime2
      : barMinutes2 >= fromTime2 || barMinutes2 <= untilTime2;

   bool ind2long  = isOnTime2;
   bool ind2short = isOnTime2;
